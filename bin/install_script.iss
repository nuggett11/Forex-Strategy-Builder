...
AppVersion         = 2.57.18.0
VersionInfoVersion = 2.57.18.0
AppVerName         = Forex Strategy Builder v2.57.18.0 Beta
...
[Files]
Source: CryptoObfuscator_Output\Forex Strategy Builder.exe; DestDir: "{app}";
